...
A rubrica cobre o CRUD em JDK 21 (sem Lombok), TypeScript/HTML/CSS e MySQL, seguido pelas capacidades IA First. Uma etapa so pode ser aprovada quando todos os criterios obrigatorios forem atendidos.
...
| 02 CRUD frontend nativo | `02-SCREENS`, `02-FORMS`, `02-STATES`, `02-A11Y` | teste de fluxo, evidencia de acessibilidade e execucao do harness | frontend nao consome contrato |
